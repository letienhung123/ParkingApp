...
<form:form modelAttribute="parkinglot" method="post" action="${action}" enctype="multipart/form-data">
    ...
    <div class="form-floating mb-3 mt-3">
        <form:input type="number" class="form-control" path="totalSpots" id="totalSpots" placeholder="Nhập số chỗ đậu..." name="totalSpots"/>
        <label for="totalSpots">Tổng số chỗ đậu</label>
    </div> 
    <div class="form-floating mb-3 mt-3">
